          ...
          {questionareStarted === false ? (
            <View style={styles.centeredView} visible={!questionareStarted}>
              <View style={styles.modalView}>
                ...
                <Text style={styles.modalText}>
                  Calculate your personal carbon footprint size
                </Text>
                <Image
            ...
            <View style={styles.centeredView} visible={!questionareStarted}>
              ...
              <TouchableOpacity style={[]} onPress={() => previousQuestion()}>
                <Text style={{bottom: 35, color: 'grey'}}>back</Text>
              </TouchableOpacity>
            </View>
          )}
        </Modal>
      ...
      <View style={styles.wrap}>
        <Modal
          ...
          <View style={styles.modalInfoNew}>
            ...
            <Text style={styles.titleModalInfoNew}>AR Footprint</Text>
            <Text style={styles.contentModalInfoNew}>
              Use your phone to scan the map given to you at the entrance or use
              one from the signs places around the exposition.
            </Text>
            <Button
